...
export const OVERVIEW_SLIDES=[
 {id:'idea',badge:'THE IDEA IN BRIEF',title:'Keep every opportunity moving.',support:'A connected growth concept for Portable Air.',body:'Follow the customer from the first conversation to a useful equipment page, a real sales connection and a visible outcome.',next:'Next: Meet the customer',visual:'pulse'},
 ...
 {id:'understand',badge:'02 / UNDERSTAND',title:'Ask about the goal before the machine.',support:'The Goal Pulse Check turns interest into useful context.',body:'A representative can guide it on a tablet, or the customer can scan a QR code and continue on their phone. A few focused choices capture the job, site, equipment needs, buying team and timing.',next:'Next: Make it personal',visual:'check'},
 {id:'personalize',badge:'03 / PERSONALIZE',title:'Give them a reason to come back.',support:'Use what they told you.',body:'Turn those answers into a personal equipment page with a useful starting point and clear next steps. Relevant email and eligible LinkedIn and YouTube retargeting can bring people back to the application and equipment they already care about.',next:'Next: Connect with a person',visual:'return'},
 {id:'connect',badge:'04 / CONNECT',title:'Put a real person behind the next step.',support:'A page starts the conversation. A representative carries it forward.',body:'The representative follows up, helps refine the equipment fit and works with the customer to arrange a site walkthrough. The request, owner and due next action stay attached to the opportunity.',next:'Next: Keep ownership visible',visual:'connect'},
 {id:'own',badge:'05 / FOLLOW THROUGH',title:'Keep ownership visible through every handoff.',support:'Routing an opportunity does not end responsibility.',body:'When a smaller opportunity moves to a dealer or distributor, keep a named internal owner. Record partner acceptance, the latest interaction, the next action and due date, and the final outcome—so the team can see where it stands and who moves it next.',note:'The workflow reflects recorded activity.',next:'Open the full experience',visual:'handoff'}
];
...
function visualMarkup(type){
 ...
 if(type==='return')return '<div class="overview-return"><div class="return-page"><span>BUILT FOR NORTHLINE CIVIL</span><img src="./assets/xas400-cutout.png" alt="Portable air compressor"><strong>Your equipment starting point</strong></div><i class="return-orbit linkedin">in</i><i class="return-orbit youtube">▶</i><i class="return-orbit mail">@</i></div>';
 if(type==='connect')return '<div class="overview-connection"><div class="connection-people"><span class="person rep">REP</span><i></i><span class="person customer">SITE</span></div><div class="connection-record"><span>OWNER</span><b>Alex Morgan</b><span>NEXT ACTION</span><b>Confirm site walkthrough</b><small>DUE · SEP 23</small></div></div>';
