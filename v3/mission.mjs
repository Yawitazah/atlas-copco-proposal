...
export const MODELS=[
 {id:'110',name:'XAS 110 KD',tag:'Compact capability',flow:110,pressure:'100',image:'xas110-cutout.png',accent:'#51c5e2',use:'A compact compressor to discuss for lower-flow tool demand.',engine:'Kubota D902',note:'A compact starting point for a lower-flow application.',url:small+'/xas-110-kd'},
 {id:'188',name:'XAS 188 CD',tag:'More air. More possibilities.',flow:189,pressure:'100',image:'xas188-cutout.png',accent:'#b8b0ff',use:'A towable option to discuss when the tool combination needs more air.',engine:'Cat C2.2T',note:'A higher-flow candidate when the job asks for more air.',url:small},
 {id:'400',name:'XAS 400-150 CD',tag:'Step into higher capacity',flow:400,pressure:'100–150',image:'xas400-cutout.png',accent:'#ffbf69',use:'A higher-flow option to review for construction, blasting or demanding site applications.',engine:'Cat C4.4',note:'A higher-capacity platform with adjustable pressure.',url:'https://www.atlascopco.com/en-us/construction-equipment/products/mobile-air-compressors-usa/medium-diesel-compressors/xas-400-150-cd'}
];
export const STEPS=[
