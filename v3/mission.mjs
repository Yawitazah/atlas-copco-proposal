...
export const MODELS=[
 {id:'110',name:'XAS 110 KD',tag:'Compact capability',flow:110,pressure:'100',image:'xas110-cutout.png',accent:'#51c5e2',use:'A compact compressor to discuss for lower-flow tool demand.',engine:'Kubota D902',weight:1100,dimensions:'79 × 48 × 51 in',sound:'70 dB(A) at 23 ft',pressureLevel:5,rangeLevel:4,signature:'Compact single-tool mobility',applications:'Small breakers, impact tools, paint stripping and mobile repair',note:'A compact starting point for a lower-flow application.',url:small+'/xas-110-kd'},
 {id:'188',name:'XAS 188 CD',tag:'More air. More possibilities.',flow:189,pressure:'100',image:'xas188-cutout.png',accent:'#b8b0ff',use:'A towable option to discuss when the tool combination needs more air.',engine:'Cat C2.2T',weight:1900,dimensions:'130 × 62 × 69 in',sound:'76 dB(A) at 23 ft',pressureLevel:5,rangeLevel:6,signature:'Balanced flow for broader tool demand',applications:'General construction and larger tool combinations',note:'A higher-flow candidate when the job asks for more air.',url:small},
 {id:'400',name:'XAS 400-150 CD',tag:'Step into higher capacity',flow:400,pressure:'100–150',image:'xas400-cutout.png',accent:'#ffbf69',use:'A higher-flow option to review for construction, blasting or demanding site applications.',engine:'Cat C4.4',weight:4700,dimensions:'167 × 72.8 × 80.6 in',sound:'82.6 dB(A) at 23 ft',pressureLevel:8,rangeLevel:9,signature:'PACE pressure flexibility',applications:'Handheld tools, sandblasting, cable blowing and shotcrete',note:'A higher-capacity platform with adjustable pressure.',url:'https://www.atlascopco.com/en-us/construction-equipment/products/mobile-air-compressors-usa/medium-diesel-compressors/xas-400-150-cd'}
];
export const STEPS=[
 {label:'Identity',badge:'On the map',xp:100,title:'First, make it yours.',sub:'Your equipment journey starts with a person.'},
 {label:'Jobsite',badge:'Requirements clarified',xp:150,title:'What does your day demand?',sub:'Tell us about your work. We will shape the experience around it.'},
 {label:'Equipment',badge:'Capability unlocked',xp:200,title:'Compare your equipment.',sub:'Compare airflow, pressure and suitability for your site.'},
 ...
 {label:'Connections',badge:'Your plan is ready',xp:100,title:'Good work travels.',sub:'Choose how you would like to bring others into the experience.'}
];
...
export const rank=s=>xp(s)<250?'Getting started':xp(s)<600?'Building your profile':xp(s)<1000?'Shaping your plan':'Ready for a conversation';
